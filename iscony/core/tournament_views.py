...
from .rendering.tournament_svg_labels import (
    effective_svg_layout_type as _effective_svg_layout_type,
...
from .rendering.tournament_svg_final import (
    add_svg_final_match as _add_svg_final_match,
)
