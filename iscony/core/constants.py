...
# DBは将来拡張用に5項目まで保持するが、通常画面と標準CSVは当面2項目だけ使う。
PARTICIPANT_ORGANIZATION_INPUT_COUNT = 2
PARTICIPANT_ORGANIZATION_INPUT_CODES = PARTICIPANT_ORGANIZATION_CODES[
    :PARTICIPANT_ORGANIZATION_INPUT_COUNT
]
